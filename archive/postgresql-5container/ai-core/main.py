...
class AICore:
    def __init__(self):
        ...
        self.db_url = os.getenv("DATABASE_URL", "postgresql://pothole_user:pothole_pass@db:5432/pothole_db")
        ...
        # 스케줄러 초기화 및 시작
        # APScheduler with explicit timezone to avoid tzlocal issues
        self.scheduler = BackgroundScheduler(timezone='UTC')
        self.setup_scheduler()
        self.scheduler.start()
        print("[OK] Scheduler started - Fine-tuning will run daily at 00:00 UTC")
